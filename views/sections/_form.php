            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <?= $form->field($model, 'section_name',['options' => ['class' => 'form-group row'],'labelOptions'=>['class'=>'col-form-label col-sm-2']])->textInput(['maxlength' => true,'class'=>'form-control','required'=>true]) ?>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-md-2">
                        </div>
